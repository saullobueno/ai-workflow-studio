...
// buttonVariants é reexportado para compor variantes em outros componentes
// (ex.: um link estilizado como botão) — convenção do próprio shadcn/ui, que
// custa a regra de fast-refresh só nesse arquivo de primitivo de UI.
